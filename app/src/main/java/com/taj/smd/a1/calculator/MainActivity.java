...
//         If there is a previous number and current number, calculate the result first
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.num0).setOnClickListener(v -> appendNum(0));
        findViewById(R.id.num1).setOnClickListener(v -> appendNum(1));
        findViewById(R.id.num2).setOnClickListener(v -> appendNum(2));
        findViewById(R.id.num3).setOnClickListener(v -> appendNum(3));
        findViewById(R.id.num4).setOnClickListener(v -> appendNum(4));
        findViewById(R.id.num5).setOnClickListener(v -> appendNum(5));
        findViewById(R.id.num6).setOnClickListener(v -> appendNum(6));
        findViewById(R.id.num7).setOnClickListener(v -> appendNum(7));
        findViewById(R.id.num8).setOnClickListener(v -> appendNum(8));
        findViewById(R.id.num9).setOnClickListener(v -> appendNum(9));
        ...
        findViewById(R.id.backspace).setOnClickListener(v ->
        {
            ...
            {
                number /= 10;
                tvDisplay.setText(df.format(number));
                tvResult.setText(df.format(number));
            }
        });
